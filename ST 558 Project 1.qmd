...
plot.state <- function(df, values = "Enrollment"){
  ...
  #Create a line plot with ggplot with appropriate aes() assignments. Have the y axis label & title dynamically generate based on values column.
...
plot.county <- function(df, values = "Enrollment", input_state = "NC", choice = "top", num_obs = 5){
  ...
  #Use a right join to join together all observations from new_df and matching observations of df. Join by area_name column.
...
g + geom_line() +
  ...
  #Decrease legend size to fit 20 counties.
...
plot.county(combo_list[[1]], "Enrollment", "NC", "top", 20)

#Bottom 7 SC Counties for Enrollment
plot.county(combo_list[[1]], "Enrollment", "SC", "bottom", 7)

#Defaults (Top 5 NC Counties for Enrollment)
plot.county(combo_list[[1]])

#Top 8 PA Counties for Enrollment
plot.county(combo_list[[1]], "Enrollment", "PA", "top", 8)
...
plot.county(all_combo[[1]], "Population", "CA", "top", 15)

#Top 4 TX Counties for Population
plot.county(all_combo[[1]], "Population", "TX", "top", 4)


#Defaults, except for values being Population (Top 5 NC Counties for Population)
plot.county(all_combo[[1]], "Population")

#Top 10 NY Counties for Population
plot.county(all_combo[[1]], "Population", "NY", "top", 10)
